CREATE TABLE IF NOT EXISTS Users (
    ...
    acessToken VARCHAR(1024) DEFAULT NULL UNIQUE,
    refreshToken VARCHAR(1024) DEFAULT NULL UNIQUE,
    tokenExpireAt TIMESTAMP DEFAULT NULL UNIQUE,
    pushToken VARCHAR(4096) DEFAULT NULL UNIQUE,
    PRIMARY KEY (id)
) ENGINE=InnoDB;
...
CREATE TABLE IF NOT EXISTS GroupPlaylists (
    groupID INTEGER NOT NULL,
